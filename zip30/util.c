  ...
  char *post;
{
    ...
    fzofft_strchr = (fzofft_strchr+ 1)% FZOFFT_NUM;

    /* Write into the current chamber. */
    sprintf( fzofft_buf[ fzofft_strchr], fmt, val);

    /* Return a pointer to this chamber. */
    return fzofft_buf[ fzofft_strchr];
}
  ...
  char *post;
{
    ...
    /* Advance the cylinder. */
    fuzofft_strchr = (fuzofft_strchr+ 1)% FZOFFT_NUM;

    /* Write into the current chamber. */
    sprintf( fuzofft_buf[ fuzofft_strchr], fmt, val);

    /* Return a pointer to this chamber. */
    return fuzofft_buf[ fuzofft_strchr];
}
